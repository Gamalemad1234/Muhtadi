...
class AzkarEvening extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            _buildAzkarItem(
              text: "أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ",
  ...
  Widget _buildAzkarItem({required String text, required String description}) {
    return Card(
